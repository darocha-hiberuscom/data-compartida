...
- Cruza con los XML SOAP de `repos/origen/servicio-dependencia`.
...
2. **Obtener URL/Endpoint**: buscar en `repos/origen/servicio-dependencia` el archivo con el nombre del servicio.
...
5. **Path XML SOAP**: los XML de origen y destino están en `repos/origen/servicio-dependencia`:
...
- [ ] URL/Endpoint obtenido de servicio-dependencia para cada servicio
...
- [ ] Si falta un XML en servicio-dependencia, marcado como `FALTA DETALLE`
...
- Formato sugerido: `L325 // IF service.error.codigo = '0' THEN`
