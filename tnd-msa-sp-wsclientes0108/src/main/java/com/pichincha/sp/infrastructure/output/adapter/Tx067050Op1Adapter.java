...
@Component
public class Tx067050Op1Adapter implements CustomerDetailCreateOutput {
    ...
    public Tx067050Op1Adapter(BancsClient bancsClient,
    ...
    public Mono<CustomerLookupResponseDto> createCustomerDetail(CustomerLookupRequestDto request) {
        ...
        return bancsClient.call(bancsRequest, Tx067050Response.class, BancsAdapterConstants.TX_067050_OP_1)
                ...
                .onErrorMap(ex -> {
                    if (ex instanceof BancsAPIClientException) {
                        ...
                        return new GlobalErrorException(
                                BancsAdapterConstants.ERROR_TX067050_OP1_HEADER,
                                BancsAdapterConstants.TX_067050_OP_1,
                    ...
                    return new GlobalErrorException(
                            BancsAdapterConstants.ERROR_TX067050_OP1_HEADER + ": " + ex.getMessage(),
                            BancsAdapterConstants.TX_067050_OP_1,
                            BancsAdapterConstants.DEFAULT_ERROR_STATUS);
                })
