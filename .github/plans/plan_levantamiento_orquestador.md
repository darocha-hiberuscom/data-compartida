...
- **Dependencias de servicios**: `repos/origen/servicios-dependencia` (XML SOAP, URLs, requests)
...
**Alcance**: Resumen global de servicios, DTOs y JSON request de ejemplo.
...
- [ ] Secciones 12, 13 y 14 del documento generadas
...
6. Aplicar reglas de `.github/prompts/shared/PROMPT_BASE_EVIDENCIA_TRAZABILIDAD.md` en todos los pasos.
...
3. Para cada paso:
   ...
   b. Analiza los archivos fuente indicados (repos/origen/proyecto-legado/ y repos/origen/servicios-dependencia/)
...
- Valida que las carpetas `repos/origen/proyecto-legado/` y `repos/origen/servicios-dependencia/` contengan los archivos del proyecto antes de lanzar.
